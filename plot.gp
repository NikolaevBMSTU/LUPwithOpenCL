...
plot '< sort -nk1 cpu.result' using 1:2 with lp lw 3 pt 6 ps 2 title "Intel Core i5-8250U, -O3", \
 ...
 '< sort -nk1 vienna.result' using 1:2 with lp lw 3 pt 7 ps 2 title "Intel UHD 620 (ViennaCL)", \
...
plot '< sort -nk1 cpu.result' using 1:2 with lp lw 3 pt 6 ps 2 title "Intel Core i5-8250U, -O3", \
 '< sort -nk1 intel.result' using 1:2 with lp lw 3 pt 24 ps 2 title "Intel UHD 620", \
 '< sort -nk1 vienna.result' using 1:2 with lp lw 3 pt 7 ps 2 title "Intel UHD 620 (ViennaCL)", \
 '< sort -nk1 amd.result' using 1:2 with lp lw 3 pt 9 ps 2 title "AMD Radeon 500 Series"
#  '< sort -nk1 intel.result' using 1:2:($2-$3):($2+$3) with yerrorbars notitle "Intel Core i5-8250U err, -O3", \
#  '< sort -nk1 amd.result' using 1:2:($2-$3):($2+$3) with yerrorbars notitle "Intel Core i5-8250U err, -O3", \
#  '< sort -nk1 vienna.result' using 1:2:($2-$3):($2+$3) with yerrorbars notitle "Intel Core i5-8250U err, -O3"
